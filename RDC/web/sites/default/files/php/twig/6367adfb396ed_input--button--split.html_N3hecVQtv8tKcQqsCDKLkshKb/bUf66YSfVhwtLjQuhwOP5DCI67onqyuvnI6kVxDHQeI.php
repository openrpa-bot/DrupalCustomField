...
class __TwigTemplate_5ece95b737bd6603eecf1d4c8ac13fd6 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 31, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/bootstrap/templates/input/input--button--split.html.twig", "C:\\xampp\\htdocs\\RDC\\web\\themes\\bootstrap\\templates\\input\\input--button--split.html.twig");
    }
