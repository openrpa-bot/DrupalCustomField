...
class __TwigTemplate_cf692bd87ee3a4177972c4cd751492be extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["description"] ?? null) && (twig_get_attribute($this->env, $this->source, ($context["description"] ?? null), "position", [], "any", false, false, true, 85) == "invisible"))) ? ("sr-only") : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/bootstrap/templates/bootstrap/bootstrap-panel.html.twig", "C:\\xampp\\htdocs\\RDC\\web\\themes\\bootstrap\\templates\\bootstrap\\bootstrap-panel.html.twig");
    }
