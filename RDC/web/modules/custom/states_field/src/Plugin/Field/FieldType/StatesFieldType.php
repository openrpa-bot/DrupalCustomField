...
namespace Drupal\states_field\Plugin\Field\FieldType;
...
/**
 * Plugin implementation of the 'states_field' field type.
 *
 * @FieldType(
 *   id = "states_field_type",
 *   label = @Translation("State Field"),
 *   description = @Translation("State to select and corresponding Image to display."),
 *   default_widget = "states_field_widget",
 *   default_formatter = "states_field_formatter",
 * )
 */
class StatesFieldType extends FieldItemBase {
